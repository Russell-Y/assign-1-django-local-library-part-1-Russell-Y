...
urlpatterns = [
    ...
    re_path(r'^media/(?P<path>.*)$', serve, {'document_root': django.conf.settings.MEDIA_ROOT}),
    re_path(r'^static/(?P<path>.*)$', serve, {'document_root': django.conf.settings.STATIC_ROOT}),
